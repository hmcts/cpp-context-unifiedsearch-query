...
public class CpsSearchApiClient {
    ...
    private static final String CASE_SEARCH_URL = BASE_CASE_SEARCH_URL + "cps-cases";
    private static final int TIMEOUT = 5000;
    private final ObjectMapper mapper = new ObjectMapper().configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
    private static final Logger LOG = LoggerFactory.getLogger(CpsSearchApiClient.class);
    ...
    private static CpsSearchApiClient searchApiClient = new CpsSearchApiClient();

    public static CpsSearchApiClient getInstance(){
    ...
    public final CaseSearchResponse searchCasesAndValidateStatusCode(final Map<String, String> parameters, final Map<String, String> additionalHeaders, int statusCode) throws IOException {
        ...
        final ImmutableMap<String, String> headers = ImmutableMap.<String, String>builder()
                ...
                .put("Accept", "application/vnd.unifiedsearch.query.cps.cases+json")
                .build();
        ...
        final CaseSearchResponse result = mapper.readValue(responseAsString, CaseSearchResponse.class);

        return result;
    }

    public final CaseSearchResponse searchWcuCases(final Map<String, String> parameters) throws IOException {

        return searchWcuCasesAndValidateStatusCode(parameters, SC_OK);
    }


    public final CaseSearchResponse searchWcuCasesAndValidateStatusCode(final Map<String, String> parameters, int statusCode) throws IOException {
        return searchWcuCasesAndValidateStatusCode(parameters, of(HeaderConstants.USER_ID, CONTEXT_USER_ID), statusCode);
    }

    private final CaseSearchResponse searchWcuCasesAndValidateStatusCode(final Map<String, String> parameters, final Map<String, String> additionalHeaders, int statusCode) throws IOException {

        final ImmutableMap<String, String> headers = ImmutableMap.<String, String>builder()
                .putAll(additionalHeaders)
                .put("Accept", "application/vnd.unifiedsearch.query.cps-wcu.cases+json")
                .build();
