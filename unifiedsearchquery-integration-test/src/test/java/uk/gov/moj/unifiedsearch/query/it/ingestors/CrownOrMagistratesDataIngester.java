...
public class CrownOrMagistratesDataIngester {
    ...
    public void loadCrownOrMagistratesCases() throws Exception {
        indexedCaseList = createCasesForCrownAndMagistrates();
        elasticSearchIndexIngestorUtil.ingestCaseData(indexedCaseList);
    }


    public List<CaseDocument> getExpectedCasesAC8_WhenCrownOrMagistratesIsTrue() {
        final List<CaseDocument> caseDocuments = asList(
                indexedCaseList.get(10), indexedCaseList.get(11),
                indexedCaseList.get(12), indexedCaseList.get(15),
                indexedCaseList.get(16), indexedCaseList.get(17));
        return caseDocuments;
    }

    public List<CaseDocument> getExpectedCasesAC8_WhenCrownOrMagistratesIsFalse() {
        final List<CaseDocument> caseDocuments = asList(
                indexedCaseList.get(0),
                indexedCaseList.get(1), indexedCaseList.get(2),
                indexedCaseList.get(3), indexedCaseList.get(4),
                indexedCaseList.get(5), indexedCaseList.get(6),
                indexedCaseList.get(7), indexedCaseList.get(8),
                indexedCaseList.get(9), indexedCaseList.get(13),
                indexedCaseList.get(14));
        return caseDocuments;
    }


    public final List<CaseDocument> createCasesForCrownAndMagistrates() {
        ...
        caseBuilderList.add(defaultCaseAsBuilder("b45d409a-4e72-403d-adb0-015f15bd89c6", "63GD6253620", false, false, false));
        ...
        */
        ...
        caseBuilderList.add(defaultCaseAsBuilder("f678854b-2bc4-41b5-8853-32d5fbaf0b3c", "89GD6995420", false, false, false));
        ...
        caseBuilderList.add(defaultCaseAsBuilder("1559f788-e155-452c-94f0-08f4cc1b180e", "78GD1219320", false, false, false));
        ...
        caseBuilderList.add(defaultCaseAsBuilder("b53725e0-4502-49d6-8a0a-60650c64aa7c", "89GD2721420", false, false, false));
        ...
        caseBuilderList.add(defaultCaseAsBuilder("25f106bc-e4f6-49d2-a22c-bca71e1a5994", "50GD4719920", false, false, false));
        ...
        caseBuilderList.add(defaultCaseAsBuilder("06a7cda8-5adf-4bd4-aa40-1b71ff9460f6", "56GD8582920", false, false, false));
        ...
        caseBuilderList.add(defaultCaseAsBuilder("af9ef369-1bfe-4b1a-a9f8-1e8c87049957", "40GD9236020", false, false, false));
        caseBuilderList.get(6).withParties(asList(party7));

        //PNC & lastname(AC-1)
        final PartyDocument.Builder party8 = createDefendantParty(randomUUID().toString(), EXPECTED_PARTY_PNC_ID_1_2099_1234567L_AC1, "123456/123", "WILL", EXPECTED_PARTY_LAST_NAME_AC1, "1938-03-15", "77 Forest Road", now().format(ISO_8601_FORMATTER), randomUUID().toString(), false);
        caseBuilderList.add(defaultCaseAsBuilder("e7bc74f3-71bd-4fcf-b622-462e7af1c289", "27GD5057120", false, false, false));
        caseBuilderList.get(7).withParties(asList(party8));
        ...
        caseBuilderList.add(defaultCaseAsBuilder("8e52ad76-5003-4a01-80b8-ba22b2cdfedb", "76GD9443920", false, false, false));
        caseBuilderList.get(8).withParties(asList(party9));

        //(pncid)&&(CRO number)&&(Defendant First && Last Name)&&(Defendant DOB)&&(Defendant Address Line 1)-AC-4
        final PartyDocument.Builder party10 = createDefendantParty(randomUUID().toString(), EXPECTED_PARTY_PNC_ID_5555_8135792K_AC4, EXPECTED_PARTY_CRO_NUMBER_123456_60g_AC4, EXPECTED_PARTY_FIRST_NAME_AC4, EXPECTED_PARTY_LAST_NAME_AC4, EXPECTED_PARTY_DOB_AC4, EXPECTED_PARTY_ADDRESS_LINE_AC4, now().format(ISO_8601_FORMATTER).toString(), randomUUID().toString(), false);
        caseBuilderList.add(defaultCaseAsBuilder("d440d3d7-ccd9-42e2-9c8a-26d64663682c", "44GD7188020", false, false, false));
