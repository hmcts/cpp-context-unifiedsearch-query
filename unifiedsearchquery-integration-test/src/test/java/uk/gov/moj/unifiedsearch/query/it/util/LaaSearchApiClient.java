...
public class LaaSearchApiClient {

    private static final String LAA_CASE_SEARCH_URL = format("http://%s:8080//unifiedsearchquery-query-api/query/api/rest/unifiedsearchquery/laa-cases", getHost());
    private static final int TIMEOUT = 5000;
    private final ObjectMapper mapper = new ObjectMapper().configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
    private static final Logger LOG = LoggerFactory.getLogger(LaaSearchApiClient.class);
    ...
    private static final LaaSearchApiClient searchApiClient = new LaaSearchApiClient();

    public static LaaSearchApiClient getInstance(){
    ...
    public final CaseSearchResponse searchCasesAndValidateStatusCode(final Map<String, String> parameters, final Map<String, String> additionalHeaders, int statusCode) throws IOException {
        ...
        final ImmutableMap<String, String> headers = ImmutableMap.<String, String> builder()
                ...
                .put("Accept", "application/vnd.unifiedsearch.query.laa.cases+json")
                .build();
