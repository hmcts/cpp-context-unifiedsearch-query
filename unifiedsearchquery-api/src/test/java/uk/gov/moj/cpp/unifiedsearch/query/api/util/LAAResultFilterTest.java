...
public class LAAResultFilterTest {
    ...
    public void shouldFilterResults() {
        ...
        final JsonObject partyValidPersonDefendant = createObjectBuilder()
                .add("defendantId", DEFENDANT_ID_PERSON)
                .add("defendantFirstName", DEFENDANT_FIRST_NAME)
                .add("defendantLastName", DEFENDANT_LAST_NAME)
                .build();
        final JsonObject partyInvalidDefendant = createObjectBuilder()
                .add("defendantId", UUID.randomUUID().toString())
                .build();
        final JsonObject partyValidOrganisationDefendant = createObjectBuilder()
        ...
        final JsonArray partiesDefendant = createArrayBuilder()
                .add(partyValidPersonDefendant)
                .add(partyInvalidDefendant)
                .build();

        final JsonArray partiesOrganisation = createArrayBuilder()
                .add(partyValidOrganisationDefendant)
                .add(partyInvalidDefendant)
                .build();

        final JsonArray partiesAll = createArrayBuilder()
                .add(partyValidPersonDefendant)
                .add(partyInvalidDefendant)
                .add(partyValidOrganisationDefendant)
                .add(partyInvalidDefendant)
                .build();
        final JsonArray partiesNone = createArrayBuilder()
                .build();
